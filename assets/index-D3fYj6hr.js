...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Aa(){return new pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Os(),fragmentShader:`
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function ba(){return new pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Os(),fragmentShader:`
...
`)}function ed(i,e){let t;switch(e){case sl:t="Linear";break;case al:t="Reinhard";break;case ol:t="Cineon";break;case ll:t="ACESFilmic";break;case ul:t="AgX";break;case hl:t="Neutral";break;case cl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Yi=new B;function td(){Ve.getLuminanceCoefficients(Yi);const i=Yi.x.toFixed(4),e=Yi.y.toFixed(4),t=Yi.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function ud(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Wa?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Bo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Yt&&(e="SHADOWMAP_TYPE_VSM"),e}function hd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Qn:case ei:e="ENVMAP_TYPE_CUBE";break;case sr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function fd(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ei:e="ENVMAP_MODE_REFRACTION";break}return e}function dd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Xa:e="ENVMAP_BLENDING_MULTIPLY";break;case il:e="ENVMAP_BLENDING_MIX";break;case rl:e="ENVMAP_BLENDING_ADD";break}return e}function pd(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function md(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=ud(t),c=hd(t),h=fd(t),f=dd(t),d=pd(t),m=nd(t),v=id(s),M=r.createProgram();let p,u,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(pi).join(`
`)),a=Cs(a),a=Oa(a,t),a=Ba(a,t),o=Cs(o),o=Oa(o,t),o=Ba(o,t),a=za(a),o=za(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
